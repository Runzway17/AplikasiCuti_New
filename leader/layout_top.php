...
<head>
    ...
    <title>Sistem Informasi Pengajuan Cuti Online PT.PT. Musashi Auto Parts Indonesia<?php echo $pagedesc ?></title>

    <link href="../libs/images/logo_msh.png" rel="icon" type="images/x-icon">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand hidden-xs" href="index.php">
                    <img src="../libs/images/logo_msh.png" alt="brand" width="32" class="float-left image-brand">
                    <div class="float-right">&nbsp;<strong>PT. Musashi Auto Parts Indonesia</strong></div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown dropdown-right">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <img src="../foto/<?php echo $res['foto_emp'] ?>"
                            width="20px"></i>&nbsp;<?php echo ucfirst($sess_leadername); ?>&nbsp;<i
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <h4>Sistem Informasi Pengajuan Cuti Online <br> <b>PT. Musashi Auto Parts Indonesia</b></h4>
                        ...
                        <a href="#"><i class="fa fa-check-square fa-fw"></i>&nbsp;Approval<span
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
                        <a href="#"><i class="fa fa-recycle fa-fw"></i>&nbsp;Pengajuan Cuti<span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <?php
